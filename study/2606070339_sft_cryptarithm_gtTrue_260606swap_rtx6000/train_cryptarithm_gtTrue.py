#!/usr/bin/env python3
"""
Fresh SFT on 260607_Cryptarithm_gtTrue.csv (gt-True new-solver crypt+eq + huikang originals; 621 crypt
CoTs refreshed from 260606 solver vs 06-04 run).

Diff vs the 06-04 cryptarithm_gtTrue trainer (per feedback_copy_sft_verbatim — verbatim except CSV swap):
  - CSV_PATH      -> /root/autodl-tmp/data/260607_Cryptarithm_gtTrue.csv (md5 e0e0c02d6f13a4cdc63893096c84a464)
  - _DATA_TAG     -> 'cryptarithm_gtTrue_260606swap'
...
Expected at startup (verify against data audit before launching real training):
  CSV rows (unique): 6441 (after 636 zero-oversample drops)
  Expanded ~7756 -> ~243 steps at bs=32 (~4 hrs at ~1 min/step)
  GT-match: 100% True
"""
...
CSV_PATH   = '/root/autodl-tmp/data/260607_Cryptarithm_gtTrue.csv'  # 621 crypt CoTs refreshed from 260606 solver vs 06-04 run -> 6441 unique -> 7756 expanded -> ~243 steps
...
_DATA_TAG  = 'cryptarithm_gtTrue_260606swap'  # 621 crypt CoTs refreshed from 260606 solver (260607 data)
