...
CSV_PATH   = '/root/autodl-tmp/data/260527_huikang_NumericEq.csv'  # combined new-solver: crypt(800,2x-mismatch) + numeric-eq(732,gtTrue) -> 7917 expanded
...
_DATA_TAG  = 'newdata_cryptnumeq'  # distinguishes this run's outputs (combined crypt+numeric-eq new-solver)
