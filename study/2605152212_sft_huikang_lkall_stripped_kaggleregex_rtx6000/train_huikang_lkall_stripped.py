#!/usr/bin/env python3
"""
Huikang 0.84 setup (run #6) + ALL cryptarithm CoTs from lkevincc.

Difference vs run #6 (2605151409_sft_huikang_golden_stripped_kaggleregex_rtx6000):
- Data: 260515_huikang_lkall_stripped.csv — 65 huikang cryptarithm CoTs swapped
  for their lkevincc counterparts. Now all 800 cryptarithm CoTs in training come
  from lkevincc (65 swapped + 735 original lkevincc additions). Non-cryptarithm
  6,106 huikang rows are byte-identical to run #6.

Everything else identical to run #6: bf16 + CCE + MoE tying, r32 a32,
lr 2e-4 linear decay, AdamW beta2=0.95, bs=32 micro=4, 9 targets + lm_head,
seq=8192, stratified batching seed=42, Kaggle-metric \\boxed extractor.
"""
...
OUTPUT_DIR = '/root/autodl-tmp/adapter_output_huikang_lkall_stripped_kaggleregex'
...
RUN_NAME = f'{_ts}_sft_huikang_lkall_stripped_kaggleregex_r32_a32_lr2e4_seq8192_bs32_rtx6000'
