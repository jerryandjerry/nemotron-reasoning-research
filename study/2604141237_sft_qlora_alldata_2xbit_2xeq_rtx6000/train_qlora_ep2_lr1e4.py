...
GRAD_ACCUM   = 1
LR           = 1e-4  # epoch 2 continuation with lower lr
WARMUP_RATIO = 0.05
...
RUN_NAME = f'{_ts}_sft_qlora_alldata_2xbit_2xeq_r32_seq2000_ep2_lr1e4_bs22_rtx6000'
...
# ── Summary ─────────────────────────────────────────────────────────
print('\n' + '='*60)
print('TRAINING SUMMARY — QLoRA Unsloth + alldata 2x bit/eq ep2 lr1e-4')
print('='*60)
