#!/usr/bin/env python3
"""
Curriculum Stage 2: Stage 1 adapter -> Stage 2 data with one continuous WSD schedule.

Same training loop/code lineage as Stage 1, except:
  - LOG_FILE/_DATA_TAG/RUN_NAME naming -> curriculum_stage2
...
CSV_PATH   = '/root/autodl-tmp/data/260614_STAGE2_FULL.csv'
...
RUN_NAME = f'{_ts}_codex_sft_stage2_wsd_contS1_rtx6000'
