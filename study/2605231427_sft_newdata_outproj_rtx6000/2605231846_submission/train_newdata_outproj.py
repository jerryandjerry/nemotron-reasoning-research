...
CSV_PATH   = '/root/autodl-tmp/data/260523_huikang_newsolver.csv'  # NEW DATA (newsolver cryptarithm CoT)
...
_DATA_TAG  = 'newdata'  # distinguishes this run's outputs from the 0.86 run
