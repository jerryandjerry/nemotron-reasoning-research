#!/usr/bin/env python3
"""
Curriculum Stage 3: Stage 2 adapter -> Stage 3 data with one continuous WSD schedule.

Same training loop/code lineage as Stage 1, except:
  - LOG_FILE/_DATA_TAG/RUN_NAME naming -> curriculum_stage3
...
INIT_ADAPTER_FROM=/root/autodl-tmp/stage3_adapter_init
"""
...
LOG_FILE = f"/root/autodl-tmp/train_log_curriculum_stage3_{'fixtie' if os.environ.get('MOE_TIE', '1') == '1' else 'notie'}{'' if os.environ.get('USE_MEM_EFF', '1') == '1' else '_outproj'}.txt"
...
RUN_NAME = f'{_ts}_codex_sft_stage3_wsd_contS2_rtx6000'
