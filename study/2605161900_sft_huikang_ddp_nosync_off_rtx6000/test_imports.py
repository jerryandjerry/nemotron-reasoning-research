#!/usr/bin/env python3
"""Pre-flight import check for DDP 2-GPU training (nosync_off variant)."""
import sys
...
print('\nAll imports OK')
print('\nLaunch (stress): STRESS_TEST=1 torchrun --nproc_per_node=2 train_huikang_ddp_nosync_off.py')
print('Launch (full):  torchrun --nproc_per_node=2 train_huikang_ddp_nosync_off.py')
