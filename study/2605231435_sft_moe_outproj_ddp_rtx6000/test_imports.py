#!/usr/bin/env python3
"""Pre-flight import check for DDP 2-GPU moe-outproj training."""
import sys
...
from peft.tuners.lora import Linear as LoraLinear; print('peft LoraLinear: OK')
...
print('\nAll imports OK')
print('Launch (stress): MOE_TIE=0 USE_MEM_EFF=0 STRESS_TEST=1 torchrun --nproc_per_node=2 train_moe_outproj_ddp.py')
print('Launch (full):   MOE_TIE=0 USE_MEM_EFF=0 torchrun --nproc_per_node=2 train_moe_outproj_ddp.py')
