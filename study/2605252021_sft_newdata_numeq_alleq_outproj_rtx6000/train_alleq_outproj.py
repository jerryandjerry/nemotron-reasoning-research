...
CSV_PATH   = '/root/autodl-tmp/data/260525_huikang_NumericEq_allEq.csv'  # allEq: keep ALL new-solver equation CoTs (no 0x drop) -> 8020 expanded
...
_DATA_TAG  = 'newdata_alleq'  # distinguishes this run's outputs (allEq keep-all variant)
