#!/usr/bin/env python3
"""
Fresh SFT on 260601_Cryptarithm_gtTrue.csv (gt-True-filtered new-solver crypt+eq + huikang originals).

Diff vs cryptnumeq trainer (per feedback_copy_sft_verbatim):
  - CSV_PATH      -> /root/autodl-tmp/data/260601_Cryptarithm_gtTrue.csv (md5 ec6c1404688adb804d8badc57118476d)
  - _DATA_TAG     -> 'cryptarithm_gtTrue'
...
CSV_PATH   = '/root/autodl-tmp/data/260601_Cryptarithm_gtTrue.csv'  # new-solver crypt+eq gt-True only + huikang originals -> 6441 unique -> 7756 expanded -> ~243 steps
...
_DATA_TAG  = 'cryptarithm_gtTrue'  # new-solver gt-True crypt+eq + huikang originals (260601 data)
