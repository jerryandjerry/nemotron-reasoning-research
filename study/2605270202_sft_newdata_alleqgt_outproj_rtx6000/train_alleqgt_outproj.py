...
CSV_PATH   = '/root/autodl-tmp/data/260527_huikang_NumericEq_allEq_gtTrue.csv'  # allEq gtTrue: regen new-solver eq CoTs, all eq cats, ONLY GT-True (113 mismatches dropped) -> 7883 expanded
...
_DATA_TAG  = 'newdata_alleqgt'  # distinguishes this run's outputs (allEq gtTrue variant)
