...
CSV_PATH   = '/root/autodl-tmp/data/260523_huikang_newsolver_gt2x.csv'  # GT2X: gold cryptarithm CoTs at 2x oversampling
...
_DATA_TAG  = 'newdata_gt2x'  # distinguishes this run's outputs from the 0.86 / newsolver / goldonly runs
