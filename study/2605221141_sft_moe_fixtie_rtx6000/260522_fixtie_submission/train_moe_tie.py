...
LOG_FILE = f"/root/autodl-tmp/train_log_moe_{'fixtie' if os.environ.get('MOE_TIE', '1') == '1' else 'notie'}.txt"
...
OUTPUT_DIR = f'/root/autodl-tmp/adapter_output_moe_{_MOE_MODE}'
ZIP_PATH   = f'/root/autodl-tmp/submission_moe_{_MOE_MODE}.zip'
...
RUN_NAME = f'{_ts}_sft_moe_{_MOE_MODE}_r32_a32_lr2e4_seq8192_bs32_rtx6000'
