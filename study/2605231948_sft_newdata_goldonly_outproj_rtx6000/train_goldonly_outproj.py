...
CSV_PATH   = '/root/autodl-tmp/data/260523_huikang_newsolver_goldonly.csv'  # GOLD-ONLY: GT-mismatch CoTs excluded (oversampling=0)
...
_DATA_TAG  = 'newdata_goldonly'  # distinguishes this run's outputs from the 0.86 / newsolver runs
